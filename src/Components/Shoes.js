...
function Shoes({ regularPrice, salePrice }) {
  ...
  return (
    <section className="shoes-collection-image-banner">
      <div className="container-liquid">
        <img
          src="/images/image-banners/shoes-collection-image-banner.webp"
          width="auto"
          height="auto"
          alt="Shoes"
        />
          ...
          <div className="row row-cols-2 row-cols-md-4 g-4">
            <div className="col">
              ...
              >
                <div className="card">
                  <img
                    src="/images/product-photos/melisandre/melisandre1.png"
                  ...
                  <div className="card-body">
                    ...
                    <h5 className="card-text text-center align-items-center">
                      <span className="regular-price">$1000</span>
                      <span className="sale-price">$800</span>
                    </h5>
                  </div>
                </div>
              </Link>
            ...
            <div className="col">
              ...
              >
                <div className="card">
                  <img
                    src="/images/product-photos/greyjoy/greyjoy1.webp"
                    className="card-img-top"
                    alt="shoes"
                  />
                  <div className="card-body">
            ...
            <div className="col">
              ...
              >
                <div className="card">
                  <img
                    src="/images/product-photos/missandei/missandei1.webp"
                    className="card-img-top"
                    alt="shoes"
                  />
                  <div className="card-body">
            ...
            <div className="col">
              ...
              >
                <div className="card">
                  <img
                    src="/images/product-photos/olenna/olenna-shoes-1.webp"
                    className="card-img-top"
                    alt="shoes"
                  />
                  <div className="card-body">
                    ...
                    <h5 className="card-text text-center align-items-center">
                      <span className="regular-price">$800</span>
            ...
            <div className="col">
              ...
              >
                <div className="card">
                  <img
                    src="/images/product-photos/myrcella/myrcella-shoes-1.webp"
                    className="card-img-top"
                    alt="shoes"
                  />
                  <div className="card-body">
            ...
            <div className="col">
              ...
              >
                <div className="card">
                  <img
                    src="/images/product-photos/tyene/tyene-shoes-1.webp"
                    className="card-img-top"
                    alt="shoes"
                  />
                  <div className="card-body">

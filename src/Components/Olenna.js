...
const Olenna = () => {
  ...
  const productImages = [
    "/images/product-photos/olenna/olenna-shoes-1.webp",
    "/images/product-photos/olenna/olenna-shoes-2.webp",
    "/images/product-photos/olenna/olenna-shoes-3.webp",
    "/images/product-photos/olenna/olenna-shoes-4.webp",
  ];
    ...
    <div className="mt-5">
      ...
      <section className="product-description-and-policies container mt-sm-3 mt-md-5">
        ...
        <div className="tab-content">
          ...
          >
            <p>
              Introducing the exquisite Olenna luxury shoes – a true embodiment
        ...
        <ProductAccordion
          description={
            <div>
              <p>
                Introducing the exquisite Olenna luxury shoes – a true
              ...
              <p>
                Enveloped in the gentle embrace of a soothing baby blue hue, the
                Olenna luxury shoes exude an aura of timeless charm and refined

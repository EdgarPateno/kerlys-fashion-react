...
const Sansa = () => {
    ...
    const productImages = [
        '/images/product-photos/sansa/sansa-2.webp',
        '/images/product-photos/sansa/sansa-1.webp',
        '/images/product-photos/sansa/sansa-3.webp',
        '/images/product-photos/sansa/sansa-4.webp',
        '/images/product-photos/sansa/sansa-5.webp',
    ];
        ...
        <div className="mt-5">
            <section className="sansa-product-page container-sm">
                <div className="row row-cols-1 row-cols-md-2 row-cols-lg-2">
                    ...
                    <ProductInfoCard productTitle="Sansa" regularPrice="$700" salePrice="$600" saveAmount="$100" />
                </div>
            </section>
            <section className="container mt-5">
                ...
                <div className="tab-content">
                    <div id="description" className={`tab-pane ${activeTab === 'description' ? 'active' : ''}`}>
                        <p className="mt-4">
                            Introducing the exquisite Sansa Luxury Bag – a true embodiment of elegance and sophistication. Crafted

...
const Daenarys = () => {
  ...
  return (
    <div className="mt-5">
      <section className="daenarys-product-page product-gallery-info-grid container-sm">
      ...
      <section className="container mt-sm-3 mt-md-5">
        ...
        <div className="tab-content">
          ...
          >
            <p>
              Introducing the exquisite Daenarys Luxury Bag – a true embodiment
        ...
        <ProductAccordion
          description={
            <div>
              <p>
                Introducing the exquisite Daenarys Luxury Bag – a true

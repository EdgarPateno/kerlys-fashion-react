    ...
    <div className="mt-5">
      ...
      <section className="product-description-and-policies container mt-sm-3 mt-md-5">
        ...
        <div className="tab-content">
          ...
          >
            <p>
              Discover the beauty of simplicity with our Brienne Earrings. This
              elegant piece is a symbol of understated sophistication. The
        ...
        <ProductAccordion
          description={
            <div>
              <p>
                Introducing the exquisite Brienne Earrings – a true embodiment

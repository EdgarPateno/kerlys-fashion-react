...
const Yara = () => {
  ...
  return (
    <div className="mt-5">
      <section className="yara-product-page product-gallery-info-grid container-sm">
      ...
      <section className="container mt-sm-3 mt-md-5">
        ...
        <div className="tab-content">
          ...
          >
            <p>
              Discover the beauty of simplicity with our Yara Pendant Necklace.
              This elegant piece is a symbol of understated sophistication. The
              sterling silver pendant hangs gracefully from a delicate chain,
              making it a versatile accessory suitable for any outfit or
              occasion.
            </p>
            <p>
        ...
        <ProductAccordion
          description={
            <div>
              <p>
                Discover the beauty of simplicity with our Yara Pendant
                Necklace. This elegant piece is a symbol of understated

...
const Arryn = () => {
    ...
    const productImages = [
        '/images/product-photos/arryn/arryn1.webp',
        '/images/product-photos/arryn/arryn2.webp',
        '/images/product-photos/arryn/arryn3.webp',
        '/images/product-photos/arryn/arryn4.webp',
    ];

    return (
        <div className="mt-5">
            <section className="arryn-product-page product-gallery-info-grid container-sm">
                <div className="row row-cols-1 row-cols-md-2 row-cols-lg-2">
                    <ProductGallerySlides images={productImages} />

                    <ProductInfoCard productTitle="Arryn" regularPrice="$1000" salePrice="$800" saveAmount="$200" />
                </div>
            </section>
            <section className="container mt-sm-3 mt-md-5">
                ...
                <div className="tab-content">
                    <div id="description" className={`tab-pane ${activeTab === 'description' ? 'active' : ''}`}>
                        <p>
                            Introducing the exquisite Arryn Luxury Bag – a true embodiment of elegance and sophistication. Crafted
                ...
                <ProductAccordion
                    description={
                        <div>
                            <p>Introducing the exquisite Arryn Luxury Bag – a true embodiment of elegance and sophistication. Crafted
                                with the utmost precision and attention to detail, this masterpiece redefines luxury in every sense.</p>
                            <p>Enveloped in the gentle embrace of a soothing baby blue hue, the Aeliana Luxury Bag exudes an aura of
                                timeless charm and refined beauty. The color evokes a sense of tranquility and grace, making it the
                                perfect companion for any occasion, whether it be a casual outing or a glamorous soirée.</p>

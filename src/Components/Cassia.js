...
const Cassia = () => {
    ...
    const productImages = [
        '/images/product-photos/cassia/cassia-1.webp',
        '/images/product-photos/cassia/cassia-2.webp',
        '/images/product-photos/cassia/cassia-3.webp',
        '/images/product-photos/cassia/cassia-4.webp',
        '/images/product-photos/cassia/cassia-5.webp',
    ];

    return (
        <div className="mt-5">
            <section className="cassia-product-page product-gallery-info-grid container-sm">
                <div className="row row-cols-1 row-cols-md-2 row-cols-lg-2">
                    <ProductGallerySlides images={productImages} />

                    <ProductInfoCard productTitle="Cassia" regularPrice="$700" salePrice="$600" saveAmount="$100" />
                </div>
            </section>
            ...
            <section className="container mt-sm-3 mt-md-5">
                ...
                <div className="tab-content">
                    <div id="description" className={`tab-pane ${activeTab === 'description' ? 'active' : ''}`}>
                        <p>
                            Introducing the exquisite Cassia Luxury Bag – a true embodiment of elegance and sophistication. Crafted
                ...
                <ProductAccordion
                    description={
                        <div>
                            <p>Introducing the exquisite Cassia Luxury Bag – a true embodiment of elegance and sophistication. Crafted
                                with the utmost precision and attention to detail, this masterpiece redefines luxury in every sense.</p>

    ...
    <div className="mt-5">
      ...
      <section className="product-description-and-policies container mt-sm-3 mt-md-5">
        ...
        <div className="tab-content">
          ...
          >
            <p>
              The Greyjoy Blossom slingback pump is crafted from suede baby goat
              leather, which is complemented by an adjustable back strap in
        ...
        <ProductAccordion
          description={
            <div>
              <p>
                The Greyjoy Blossom slingback pump is crafted from suede baby

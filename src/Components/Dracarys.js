...
const Dracarys = () => {
  ...
  const productImages = [
    "/images/product-photos/dracarys/dracarys-1.webp",
    "/images/product-photos/dracarys/dracarys-2.webp",
    "/images/product-photos/dracarys/dracarys-3.webp",
    "/images/product-photos/dracarys/dracarys-4.webp",
    "/images/product-photos/dracarys/dracarys-5.webp",
  ];

  return (
    <div className="mt-5">
      <section className="dracarys-product-page product-gallery-info-grid container-sm">
        <div className="row row-cols-1 row-cols-md-2 row-cols-lg-2">
          <ProductGallerySlides images={productImages} />

          <ProductInfoCard
            id="8"
            productTitle="Dracarys"
            regularPrice="1000"
            salePrice="800"
            saveAmount="200"
          />
      ...
      <section className="container mt-sm-3 mt-md-5">
        ...
        <div className="tab-content">
          ...
          >
            <p>
              Introducing the exquisite Dracarys Luxury Bag – a true embodiment
        ...
        <ProductAccordion
          description={
            <div>
              <p>
                Introducing the exquisite Dracarys Luxury Bag – a true

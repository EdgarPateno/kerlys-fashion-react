...
const Catelyn = () => {
    ...
    const productImages = [
        '/images/product-photos/catelyn/catelyn1.webp',
        '/images/product-photos/catelyn/catelyn2.webp',
        '/images/product-photos/catelyn/catelyn3.webp',
        '/images/product-photos/catelyn/catelyn4.webp',
    ];

    return (
        <div className="mt-5">
            <section className="catelyn-product-page container-sm">
                    ...
                    <div className="product-info-content col">
                        <div className="card">
                            <div className="card-body">
                                ...
                                <h5 className="h1" id="productTitle">Catelyn</h5>
            ...
            <section className="container mt-5">
                ...
                <div className="tab-content">
                    <div id="description" className={`tab-pane ${activeTab === 'description' ? 'active' : ''}`}>
                        <p className="mt-4">
                            Introducing the exquisite Catelyn Luxury Bag – a true embodiment of elegance and sophistication. Crafted
                ...
                <ProductAccordion
                    description={
                        <div className="mt-4">
                            <p>Introducing the exquisite Catelyn Luxury Bag – a true embodiment of elegance and sophistication. Crafted
                                with the utmost precision and attention to detail, this masterpiece redefines luxury in every sense.</p>
                            <p>Enveloped in the gentle embrace of a soothing baby blue hue, the Aeliana Luxury Bag exudes an aura of
                                timeless charm and refined beauty. The color evokes a sense of tranquility and grace, making it the
                                perfect companion for any occasion, whether it be a casual outing or a glamorous soirée.</p>

...
const ReturnRefundExchange = () => {
  return (
    <section className="returnRefundExchange container my-5">
      <h1>Return and Refund Policy</h1>
      <p>Last updated: November 25, 2023</p>
      <p>Thank you for shopping at Kerlys Fashion.</p>
      <p>
      ...
      <ul>
        <li>
          <p>
            ...
            this Agreement) refers to Kerlys Fashion LLC, 1221 Bubby Drive, San
            Marcos, Texas 78666..
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Kerlys Fashion, accessible from{" "}
            <a
              href="https://kerlys-fashion-react.netlify.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://kerlys-fashion-react.netlify.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <p>
        The deadline for cancelling an Order is 30 days from the date on which
      ...
      <ul>
        <li>
          By email:{" "}
          <a href="email:support@kerlysfashion.com">[KERLYS FASHION]</a>
        </li>
      </ul>
      <p>
      ...
      <p>1221 Bubby Drive, San Marcos, Texas 78666.</p>
      <p>

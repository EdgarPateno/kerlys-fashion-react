    ...
    <div className="mt-5">
      ...
      <section className="container mt-sm-3 mt-md-5">
        ...
        <div className="tab-content">
          ...
          >
            <p>
              Elevate your wrist with our Ygritte luxury bracelet, a masterpiece
              of elegance and individuality. This bracelet is more than just
              jewelry; it's a reflection of your unique style and personality.
              Crafted with meticulous attention to detail, it features an array
              of delicate charms that tell a story of love, adventure, and
              cherished memories.
            </p>
            <p>
        ...
        <ProductAccordion
          description={
            <div>
              <p>
                Elevate your wrist with our Ygritte luxury bracelet, a
                masterpiece of elegance and individuality. This bracelet is more
                than just jewelry; it's a reflection of your unique style and
                personality. Crafted with meticulous attention to detail, it
                features an array of delicate charms that tell a story of love,

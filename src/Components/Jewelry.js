                    ...
                    <div className="row row-cols-2 row-cols-md-4 g-4">
                        ...
                        <div className="col">
                            <Link to="/brienne" onClick={() => headerRef.current.scrollIntoView({ behavior: 'smooth' })}>
                                <div className="card">
                                    <img src="/images/product-photos/brienne/brienne1.webp" className="card-img-top" alt="hoops" />
                                    <div className="card-body">
                        ...
                        <div className="col">
                            <Link to="/shae" onClick={() => headerRef.current.scrollIntoView({ behavior: 'smooth' })}>
                                <div className="card">
                                    <img src="/images/product-photos/shae/shae1.webp" className="card-img-top" alt="necklace" />
                                    <div className="card-body">

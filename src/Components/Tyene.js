...
const Tyene = () => {
  ...
  const productImages = [
    "/images/product-photos/tyene/tyene-shoes-1.webp",
    "/images/product-photos/tyene/tyene-shoes-2.webp",
    "/images/product-photos/tyene/tyene-shoes-3.webp",
    "/images/product-photos/tyene/tyene-shoes-4.webp",
  ];
    ...
    <div className="mt-5">
      ...
      <section className="product-description-and-policies container mt-sm-3 mt-md-5">
        ...
        <div className="tab-content">
          ...
          >
            <p>
              Introducing the exquisite Tyene luxury shoes – a true embodiment
            ...
            <p>
              ...
              Tyene luxury shoes exudes an aura of timeless charm and refined
        ...
        <ProductAccordion
          description={
            <div>
              ...
              <p>
                Enveloped in the gentle embrace of a soothing baby blue hue, the
                Tyene luxury shoes exude an aura of timeless charm and refined

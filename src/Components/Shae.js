        ...
        <div className="mt-5">
            <section className="shae-product-page container-sm">
                <div className="row row-cols-1 row-cols-md-2 row-cols-lg-2">
                    ...
                    <ProductInfoCard productTitle="Shae" regularPrice="$1000" salePrice="$800" saveAmount="$200" />
                </div>
            </section>
            <section className="container mt-sm-3 mt-md-5">
                ...
                <div className="tab-content">
                    <div id="description" className={`tab-pane ${activeTab === 'description' ? 'active' : ''}`}>
                        <p>Discover the beauty of simplicity with our elegant and timeless Shae necklace. This elegant piece is
